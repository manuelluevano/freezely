...
export const productImages = [
  ...
  { src: img2, alt: "Producto 2" },
  { src: img3, alt: "Producto 3" },
  { src: img4, alt: "Producto 4" },
  { src: img5, alt: "Producto 5" },
  { src: img6, alt: "Producto 6" },
  { src: img7, alt: "Producto 7" },
  { src: img8, alt: "Producto 8" },
  { src: img9, alt: "Producto 9" },
  { src: img10, alt: "Producto 10" },
  { src: img11, alt: "Producto 11" },
  { src: img12, alt: "Producto 12" },
  { src: img13, alt: "Producto 13" },
